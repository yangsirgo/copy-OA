...
define(function(require,exports) {
    ...
    //角色级联事件
    $("#table_conCurrentRole tr select:even").live("change",function(){
        //绑定角色
        act_common.wf_bindRole($(this).val(), $(this).next());
    })
    //删除角色
    $("#table_conCurrentRole img").live("click",function(){
    ...
    //添加并签角色
    $("#a_AddConCurrentRole").live("click",function(){
        addRole();
    })
    function addRole(){
    ...
    //提交方法
    $("#txt_conCurrentSubmit").live("click",function(){
        ...
        //封装数据
        act_common.wf_addActity(wf_graph.getSelectionCell().id, $.trim(txt_conCurrentTitle.val()), 2, 0, Approver, ApproverType, "",todoTime,skipTime);
