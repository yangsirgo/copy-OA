...
define(function (require) {
    ...
    var control_prototype = {
        ...
        filled: function (ctrl) {
            ...
            var ksnSelectUser = require("../fw_selector");
            ksnSelectUser.KSNSelector({ model: _model, element: "#" + _curId, searchType: { "org": false, "user": true, "grp": false } ,width:"none"});
        },
        inputs: function () {
        ...
        cformat: function () {
            var ctrl_tpl = require('../template/control-selector.tpl');
