...
define(function (require, exports) {
    ...
    var fw_selector = require("workflow/javascripts/plugins/i8selector/fw_selector");
    var i8ui = require('./i8ui.js');
    var _hash = require('./gethashjson.js');
    var fw_page = require('./fw_pagination.js');
    ...
    var PageInit = function () {
        ...
        (function () {
            ...
            var getCategory = function (pageIndex) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var tpl = require('workflow/template/design/category-list.tpl');
            ...
            var getDataSourceList = function (pageIndex) {
                ...
                var processdatarender = template(require('workflow/template/design/processdatalist.tpl'));
                var _page = processdata.find('.pagination').empty();
                //var getSourceData = function () {
                $.ajax({
                    url: '../json/getDataSourceList.json',
                    type: 'get',
                    data: {pageIndex: pageIndex, pageSize: pageSize},
                    dataType: 'json',
                    beforeSend: function () {
...
//                showbox.show();
        ...
        $(function () {
            ...
            var getRoleList = function (pageIndex) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var tpl = require('workflow/template/design/specialrole.tpl');
                        var render = template(tpl);
            ...
            var outputWin = function (options, callback) {
                ...
                var tpl = require('workflow/template/design/specialrole-pop.tpl');
                var render = template(tpl);
