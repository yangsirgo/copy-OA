 ...
 * pageSelector - Optional boolean that specifies if the page i8selector
 ...
 * 
 * Boolean that specifies if the page i8selector should be
...
mxPrintPreview.prototype.writeHead = function(doc, css)
{
	...
	// NOTE: position: fixed is not supported in IE, so the page i8selector
 ...
 * 
 * Creates the page i8selector table.
 */
